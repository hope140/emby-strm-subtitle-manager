...
- D2/D3 的旧“单源/专用 Add”文档保留其历史 Canary 证据，但当前实现契约以本 ADR 和 [Core A/B 实现评审](../../records/reviews/core-ab-implementation-review.md) 为准。
...
- [Core A/B 连续实施计划](../../planning/core-ab-implementation-plan.md) 与 [Core A/B 实现评审](../../records/reviews/core-ab-implementation-review.md)。
