...
完整证据见 [BASELINE.md](../../planning/phase1-baseline.md) 和 [CSF_REUSE_MATRIX.md](../../planning/chinesesubfinder-reuse-matrix.md)。
...
- 上游构建和工具链结果：[BASELINE.md](../../planning/phase1-baseline.md)
- 模块耦合和复用边界：[CSF_REUSE_MATRIX.md](../../planning/chinesesubfinder-reuse-matrix.md)
- 项目当前架构：[architecture.md](../../reference/architecture.md)
- Phase 1 门禁：[phase1-baseline-checklist.md](../../planning/phase1-baseline-checklist.md)
- 已接受的 Bridge 决策：[ADR-001](001-v1-uses-emby-remote-subtitle-bridge.md)
- Gate 0 事实起点：[GATE0_REPORT.md](../../records/acceptance/gate0-report.md)
