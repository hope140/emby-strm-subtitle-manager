...
依据为 [当前架构](architecture.md)、[D2 搜索预览契约](d2-search-preview-contract.md)、[ADR-005](adr/005-conditional-d2-entry-without-live-multisource.md) 和 [本机操作文档](../LOCAL_OPERATIONS.md)。本机操作文档只用于连接和边界核对，未把其中的历史部署快照当作当前运行状态证明。
