...
- 实际运行、日志或可复现结果　真实 C92 Add、Emby 字幕流、应用字幕清单、Emby Web 客户端读取，以及环境负责人补充的手机端实际播放确认，已在 [D3 C92 Canary 验收](../acceptance/d3-c92-canary-acceptance-20260825.md) 中单独记录；D3 写入窗口随后已恢复为 closed。
