...
| [ADR-006 管理员会话与自动化凭据](adr/006-admin-session-and-automation-credentials.md) | 发布镜像的管理员登录、Docker Secret 配置、自动化 Token 分离和 D2.5 排期 | D3 写入和多用户系统 |
| [D2.5 管理员认证](d2.5-admin-auth.md) | D2.5-A/B 当前实现、会话契约、Compose Secret、测试证据和剩余门禁 | C92/SH 部署、scope、CSRF 和 D3 写入 |
